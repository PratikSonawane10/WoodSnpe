package com.mobitechs.woodsnipe.imageSelect;
...
public class Image {
    ...
    public Image(School_Details school_Details, String activityName, OnRecyclerSetImageListener onRecyclerSetImageListener) {
        this.activity = school_Details;
