...
public class BDay_Yesterday_Tab extends Fragment implements View.OnClickListener {
    ...
    public String yesterdayBdayResponse;
...
//        progressDialog.show();
    ...
    public class BdayListWebservice extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            yesterdayBdayResponse = WebService.TodaysBday(bDate, method);
            return null;
        }

        @Override
        protected void onPostExecute(Void res) {
            if (yesterdayBdayResponse.equals("BDay List not Available.")) {
//                progressDialog.dismiss();

            } else if (yesterdayBdayResponse.equals("No Network Found")) {
//                progressDialog.dismiss();
...
//                progressDialog.dismiss();
                ...
                try {
                    JSONArray jArr = new JSONArray(yesterdayBdayResponse);
